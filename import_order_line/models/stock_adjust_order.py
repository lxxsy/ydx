...
class StockAdjustOrder(models.Model):
    _inherit = "stock.inventory"

    @api.multi
    def action_open_import_stock_adjust_order_line_wizard(self):
        """
        ...
        wizard_id = self.env['import.stock.adjust.order.line.wizard'].create(dict(master_id=self.id))
