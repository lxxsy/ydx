...
class ResConnectionMetal(models.Model):
    _name = 'res.connection.metal'
    _inherit = ['mail.thread', 'mail.activity.mixin', 'portal.mixin']
    _description = "Connection Metal"
    _order = 'id asc'
    ...
    product_id = fields.Many2one('product.product', string='Product',required=True, domain=[('fuction_type', '=', 'cmetals')], change_default=True, ondelete='restrict')
    ...
    def create(self, vals):
        ...
        return super(ResConnectionMetal, self).create(vals)
