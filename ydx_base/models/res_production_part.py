...
class ResProductionPart(models.Model):
    ...
    # product_id = fields.Many2one('product.product', string='Product', domain=[('fuction_type', '=', 'parts')], required=True, change_default=True, ondelete='restrict')
    product_name = fields.Char(string='构件名称')
