...
class YdxSaleStockRule(models.Model):
    ...
    def _get_custom_move_fields(self):
        ...
        fields += ['sale_return_line_id', 'partner_id', 'product_name', 'cabinet_no', 'material', 'product_colour','width','length', 'thickness', 'remarks', 'product_opento','product_speci_type','outsource_quantity']
        return fields
